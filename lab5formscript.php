...
<body>
  <div style="text-align:center;">
	...
	<p>This page will display the results of them form that was submitted to it.</p>
  </div>
  <hr><br>
  ...
  <div class="box">
  <h2>This section contains the hidden infromation:</h2>
